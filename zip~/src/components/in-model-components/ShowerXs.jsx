...
// export function ShowerXs({ isSelected, ...props }) {
//   const { nodes, materials } = useGLTF('./models/parts144/shower_XS.glb');
...
//       <group position={[0.477, 1.471, -0.97]} scale={[1, 1, 0.728]}>
...
// useGLTF.preload('./models/parts144/shower_XS.glb');
...
export default function ShowerXs(props) {
  const { nodes, materials } = useGLTF('./models/in-parts144/shower_XS.glb')
  return (
    <group {...props} dispose={null}>
      <group position={[0.477, 1.471, -0.97]} scale={[1, 1, 0.728]}>
        <mesh
...
useGLTF.preload('./models/in-parts144/shower_XS.glb')